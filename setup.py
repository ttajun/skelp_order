...
setup(
    ...
    description         = 'BBDR - crawler for shopping mall.',
    ...
    author_email        = 'ttajun@bbdr.co.kr',

    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url                 = 'http://www.bbdr.co.kr/',

    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url        = 'http://www.bbdr.co.kr/',

    # 해당 패키지를 사용하기 위해 필요한 패키지를 적어줍니다. ex. install_requires= ['numpy', 'django']
    # 여기에 적어준 패키지는 현재 패키지를 install할때 함께 install됩니다.
    install_requires    =  ['selenium>=4.1.0', 'beautifulsoup4', 'pandas', 'paramiko', 'scp', 'webdriver-manager', 'pymongo', 'fake-useragent'],
    ...
    entry_points={
        'console_scripts': [
            'bbdr-cshop=bbdr_cshop.app:main',
        ],
    },
    # scripts=[''],
